...
p. A fuzzy based query that uses similarity based on Levenshtein (edit distance) algorithm. The fuzzy query maps to Lucene @FuzzyQuery@.
...
p(note). Note: The @min_similarity@ parameter maps to Lucenes @FuzzyQuery@ @maxEdits@.
